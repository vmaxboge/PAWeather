...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self initForecastViewHeader];
    //天气预报页滚动条
    UIScrollView *forecastScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 50, 375, 617)];
    [self initForecastViewFirstSection:forecastScrollView];
    [self initForecastSecondSection:forecastScrollView];
    [self initForecastViewThirdSection:forecastScrollView];
    [self initForecastViewFourthSection:forecastScrollView];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSMutableArray *functionList = [NSMutableArray arrayWithCapacity:6];
    PAFunctionList *function1 = [[PAFunctionList alloc]init];
    [function1 setFunctionListImageName:@"umbrella"];
    [function1 setFunctionListDescription:@"不用带伞"];
    PAFunctionList *function2 = [[PAFunctionList alloc]init];
    [function2 setFunctionListImageName:@"t_shirt"];
    [function2 setFunctionListDescription:@"衬衫"];
    PAFunctionList *function3 = [[PAFunctionList alloc]init];
    [function3 setFunctionListImageName:@"vacation"];
    [function3 setFunctionListDescription:@"不宜旅行"];
    PAFunctionList *function4 = [[PAFunctionList alloc]init];
    [function4 setFunctionListImageName:@"weather"];
    [function4 setFunctionListDescription:@"需要防晒"];
    PAFunctionList *function5 = [[PAFunctionList alloc]init];
    [function5 setFunctionListImageName:@"limit"];
    [function5 setFunctionListDescription:@"单号限行"];
    PAFunctionList *function6 = [[PAFunctionList alloc]init];
    [function6 setFunctionListImageName:@"ball"];
    [function6 setFunctionListDescription:@"不宜运动"];
    [functionList addObject:function1];
    [functionList addObject:function2];
    [functionList addObject:function3];
    [functionList addObject:function4];
    [functionList addObject:function5];
    [functionList addObject:function6];
    ...
    PAFunctionList *functionObject = [functionList objectAtIndex:indexPath.row];
    forecastCell.forecastCellLabel.text = functionObject.functionListDescription;
    forecastCell.forecastCellImageView.image = [UIImage imageNamed:functionObject.functionListImageName];
    return forecastCell;
}
...
//初始化Forecast页面第一部分
- (void)initForecastViewFirstSection:(UIScrollView *)scrollView{
    ...
    //数据初始化
    PAWeatherDescription *weatherDescriptionObject = [[PAWeatherDescription alloc]init];
...
- (void)initForecastSecondSection:(UIScrollView *)scrollView{
...
- (void)initForecastViewThirdSection:(UIScrollView *)scrollView{
...
-(void)initForecastViewFourthSection:(UIScrollView *)scrollView{
